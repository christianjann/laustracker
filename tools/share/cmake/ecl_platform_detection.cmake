# http://www.ros.org/wiki/ecl_build/Tutorials/The%20Ecl%20CMake%20Library
# https://github.com/stonier/ecl_tools/blob/groovy-devel/ecl_build/cmake/modules/ecl_platform_detection.cmake
...
macro(ecl_detect_distro)
    if(EXISTS "/etc/issue")
        ...
        string(REGEX MATCH "Ubuntu" DISTRO_UNKNOWN_UBUNTU ${ETC_ISSUE})
    endif()
    if(DISTRO_KARMIC)
    ...
    elseif(DISTRO_UNKNOWN_UBUNTU)
        set(DISTRO_NAME "Ubuntu")
        set(DISTRO_VERSION "unknown")
        set(DISTRO_VERSION_STRING "unknown")
    else()
